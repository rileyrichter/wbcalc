const submitEmailButton = document.getElementById("next");
...
// Sets the form submit button as a variable
...
form.addEventListener("click", function (evt) {
  ...
  fetch("https://dev--wrapbook-calculator.bparker.autocode.gg/", requestOptions)
